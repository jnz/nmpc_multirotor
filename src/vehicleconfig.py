...
class CopterConfig:
    def __init__(self):
        ...
        if vehicle == 18:
            ...
            self.max_horizontal_velocity_mps = 15.0  # max vertical velocity of the vehicle in m/s
            ...
            self.max_rotation_rate_rps = np.deg2rad(15.0)  # max. rotation rate in rad/s
            # </manned multirotor aircraft>
        elif vehicle == 4:
            # <quadcopter>
